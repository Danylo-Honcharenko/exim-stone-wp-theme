...
var bootstrap_bundle = __webpack_require__(414);
...
const mainMenu = jquery_module("#main-menu");

const menuCallback = (entries) => {
    entries.forEach((entry) => {
        if (entry.isIntersecting) {
            mainMenu.removeClass("fixed-top justify-content-center top-vr blur-bg pt-3 pb-3");
        } else {
            mainMenu.addClass("fixed-top justify-content-center top-vr blur-bg pt-3 pb-3");
        }
    });
};
...
jquery_module(document).ready(function(){
    jquery_module("#swiper-items-next").on("click", function(e){
        e.preventDefault();
        swiper.slideNext();
    });
    jquery_module("#swiper-items-prev").on("click", function(e){
        e.preventDefault();
        swiper.slidePrev();
    });
});
...
jquery_module(document).ready(function(){
    jquery_module("#swiper-item-next").on("click", function(e){
        e.preventDefault();
        swiperItem.slideNext();
    });
    jquery_module("#swiper-item-prev").on("click", function(e){
        e.preventDefault();
