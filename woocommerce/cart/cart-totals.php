...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
	...
	<h2 class="fw-lighter"><?php esc_html_e( 'Cart totals', 'woocommerce' ); ?></h2>

	<div class="shop_table shop_table_responsive d-flex flex-column gap-2">

		<div class="cart-subtotal d-flex justify-content-between">
			<p class="mb-0"><?php esc_html_e( 'Subtotal', 'woocommerce' ); ?></p>
			<p class="mb-0" data-title="<?php esc_attr_e( 'Subtotal', 'woocommerce' ); ?>"><?php wc_cart_totals_subtotal_html(); ?></p>
		</div>
		...
		<div class="order-total d-flex justify-content-between">
			<p class="mb-0"><?php esc_html_e( 'Total', 'woocommerce' ); ?></p>
			<p class="mb-0" data-title="<?php esc_attr_e( 'Total', 'woocommerce' ); ?>"><?php wc_cart_totals_order_total_html(); ?></p>
		</div>
