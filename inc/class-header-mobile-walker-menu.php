<?php
class Header_Mobile_Walker_Menu extends Walker_Nav_Menu {
	...
	public function start_lvl( &$output, $depth = 0, $args = null ) {
		...
		// Default class.
		$classes = array( 'dropdown-menu text-capitalize' );
...
//		$id = apply_filters( 'nav_menu_item_id', 'menu-item-' . $menu_item->ID, $menu_item, $args, $depth );
		...
		if ($depth == 0 && $menu_item->menu_order != 1) {
			$output.= '<hr>';
		}
		...
		if ($this->has_children && $depth == 0) {
			...
			$atts['href'] = '#';
			$atts['class'] = 'dropdown-item dropdown-submenu-toggle';
			$atts['data-bs-toggle'] = 'dropdown';
		} else {
